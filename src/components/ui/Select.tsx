...
>(({ className, children, label, error, id, ...props }, ref) => {
  ...
  return (
    <div className="w-full">
      {label && (
        <label htmlFor={triggerId} className="mb-1.5 block text-sm font-medium text-foreground">
          {label}
        </label>
      )}
      <SelectPrimitive.Trigger
        ...
        className={cn(
          ...
          'focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-1',
